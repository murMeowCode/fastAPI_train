...
from test_app.crud.meeting_room import create_meeting_room,get_room_id_by_name
from test_app.schemas.meeting_room import MeetingRoomCreate, MeetingRoomDB
...
async def create_new_meeting_room(
    ...
    if room_id is not None:
        raise HTTPException(status_code=422,detail="Переговорка с таким именем уже существует")
